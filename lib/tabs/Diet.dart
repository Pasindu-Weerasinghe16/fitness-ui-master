        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              bottom: TabBar(
                tabs: <Widget>[
                  Container(height: 30.0, child: Tab(text: 'Breakfast')),
                  Container(height: 30.0, child: Tab(text: 'Lunch')),
                  Container(height: 30.0, child: Tab(text: 'Dinner')),
                  Container(height: 30.0, child: Tab(text: 'Snacks')),
                ],
